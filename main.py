...
logging.basicConfig(filename='lana.log', level=logging.ERROR,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# my news api
newsapi_key = "Enter your key here please "
        ...
        with sr.Microphone() as source:
            ...
            while True:
                ...
                try:
                    ...
                    if trigger_word_active and 'lana' in command:
                        command = command.replace('lana', '').strip()
...
async def get_weather(city_name: str):
    api_key = "Enter your key here please"
...
def run_lana(trigger_word_active=True):
    ...
    if command:
        ...
        if not command_handled:
            ...
            if 'temperature in' in command:
                ...
                talk('My name is lana.')
                command_handled = True
            elif 'who are you' in command:
                talk('I am lana, your personal assistant. How can I help you today?')
                command_handled = True
                ...
                talk('I like cricket.')
                command_handled = True
            elif 'who Anurag Jha' in command:
                talk('Anurag Jha is a student who is pursuing BSc in Computer Science.')
                talk('who has designed and developed me as a AI assistant. If you have any other questions, feel free to ask!')
                command_handled = True
            elif 'who created you' in command:
                talk("I was created by Anurag Jha, who designed and developed me as a personal assistant. If you have any other questions, feel free to ask!")
                command_handled = True
...
print("Hello, I am Lana, your virtual assistant. I am now activated and ready to assist you.")
talk("Hello, I am Lanaaa, your virtual assistant. I am now activated and ready to assist you.")
...
while True:
    try:
        if not run_lana(trigger_word_active):
            break
